...
class RiskMixin:
    ...
    def _get_spot_range(
        ...
        Args:
            ...
            use_comprehensive_range: If True, creates a comprehensive range
            that includes extreme scenarios (spot near $0, very high spot
            prices) with critical points to ensure accurate max loss/profit
    ...
    def calculate_max_loss_options(
        ...
        values to ensure accurate max loss detection for all portfolio types.
        ...
        # Check for unlimited loss (naked short calls have unlimited loss
        # potential)
    ...
    def calculate_max_profit_options(
        ...
        CRITICAL: Checks extreme scenarios including spot = $0 and high spot
        values to ensure accurate max profit detection for all portfolio types.
        ...
        # Check for unlimited profit (long calls have unlimited profit
        # potential)
        has_long_calls = any(
            pos.quantity > 0 and pos.option.option_type == OptionType.CALL
            for pos in self.positions
