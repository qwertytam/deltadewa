...
`tests/test_app/test_design.py` reaches 26 private `_..._logic`/helper
...
from .page import _add_position_logic as _add_position_logic
from .page import _aging_calendar_row as _aging_calendar_row
from .page import _expiry_window_text as _expiry_window_text
from .page import _import_logic as _import_logic
from .page import _ladder_maturities_text as _ladder_maturities_text
from .page import _mark_inputs_reviewed_logic as _mark_inputs_reviewed_logic
from .page import _net_delta_readout as _net_delta_readout
from .page import _remove_position_logic as _remove_position_logic
from .page import (
