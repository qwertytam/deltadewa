...
class TestStaticProvider:
    ...
    def test_get_spot_returns_registered_price(self) -> None:
        ...
        assert provider.get_spot("SPX") == pytest.approx(5000.0, rel=1e-2)
    ...
    def test_get_vix_returns_configured_value(self) -> None:
        ...
        assert provider.get_vix() == pytest.approx(22.5, rel=1e-4)
    ...
    def test_get_vix_term_structure_returns_a_copy(self) -> None:
        ...
        assert provider.get_vix_term_structure()["VIX"] != pytest.approx(
            -1.0, rel=1e-4
        )
    ...
    def test_get_skew_index_returns_configured_value(self) -> None:
        ...
        assert provider.get_skew_index() == pytest.approx(135.0, rel=1e-5)
    ...
    def test_get_skew_percentile_ignores_lookback_days(self) -> None:
        ...
        assert provider.get_skew_percentile(lookback_days=30) == pytest.approx(
            0.75, rel=1e-4
        )
        assert provider.get_skew_percentile(lookback_days=500) == pytest.approx(
            0.75, rel=1e-4
        )
