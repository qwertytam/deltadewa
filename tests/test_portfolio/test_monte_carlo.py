...
class TestMonteCarloMixin:
    ...
    def test_calculate_probability_of_profit(self):
        ...
        # Test backward compatible keys
        assert "probability" in result
        assert "expected_value" in result
        assert "breakeven_points" in result
        
        # Test new enriched keys
        ...
        # expected_value and expected_pnl should be the same
        assert result["expected_value"] == result["expected_pnl"]
    ...
    def test_probability_high_simulations(self):
        ...
        result = portfolio.calculate_probability_of_profit(num_simulations=10000)
    ...
    def test_vectorized_vs_scalar_consistency(self):
        ...
        pnls = portfolio._vectorized_pnl_at_expiry(test_spots, include_underlying=False)
